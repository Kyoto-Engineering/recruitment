        ...
        <div>
            ...
            <p>
                ...
                <p>
                    ...
                    <input class="w3-radio" type="radio"  name="tLenth" value="day">
                    <label>Day(s)</label>
                    
                    <input class="w3-radio" type="radio"  name="tLenth" value="week">
                    <label>Week(s)</label>
                    
                    <input class="w3-radio" type="radio"  name="tLenth" value="month">
                    <label>Month(s)</label>
                </p>
